            ...
            >
              <Row className="mb-3">
                <Form.Group as={Col} controlId="formGridState">
                  <Form.Label className="ct">카테고리</Form.Label>
                  <Form.Select
                    name="boardTypeId"
                    style={{ width: "300px" }}
                ...
                <Form.Group as={Col} controlId="formGridTitle">
                  <Form.Label className="tt">제목</Form.Label>
                  <Form.Control
                    name="title"
                    style={{ width: "600px" }}
                ...
                <Form.Group controlId="formFileMultiple" className="mb-3">
                  <Form.Label className="fu">파일 업로드</Form.Label>
                  <Form.Control
                    name="files"
                    type="file"
                    multiple
                ...
                <div className="form-f-flies">
                  {content.data.attachedFiles &&
                    content.data.attachedFiles.map(
                      (file) =>
                        file.filepath !== null && (
                          <li key={file.no} className="file-name" id={`li-${file.no}`}>
                            <a
                              href={`${file.filepath}`}
                            >
                ...
                >
                  <Form.Label className="cc">내용</Form.Label>
                  {/* <Form.Control
                    name="content"
                    as="textarea"
